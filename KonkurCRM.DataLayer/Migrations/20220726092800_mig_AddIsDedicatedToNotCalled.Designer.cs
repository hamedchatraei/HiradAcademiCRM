...
namespace KonkurCRM.DataLayer.Migrations
{
    ...
    [Migration("20220726092800_mig_AddIsDedicatedToNotCalled")]
    partial class mig_AddIsDedicatedToNotCalled
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Advisers.AdviserInvoice", b =>
                {
                    b.Property<int>("AdviserInvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdviserInvoiceId"), 1L, 1);
                    ...
                    b.Property<DateTime>("PaySalaryDate")
                    ...
                    b.HasKey("AdviserInvoiceId");

                    b.HasIndex("AdviserId");

                    b.HasIndex("SalaryTypeId");

                    b.ToTable("AdviserInvoices");
                });
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Calls.NotCalled", b =>
                {
                    b.Property<int>("NotCalledId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NotCalledId"), 1L, 1);
                    ...
                    b.HasKey("NotCalledId");

                    b.HasIndex("AdviserId");

                    b.ToTable("NotCalleds");
                });
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Pays.Installment", b =>
                {
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Pays.PayType", b =>
                {
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Salary.SalaryType", b =>
                {
                    b.Property<int>("SalaryTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Advisers.AdviserInvoice", b =>
                {
                    b.HasOne("KonkurCRM.DataLayer.Entities.Advisers.Adviser", "Adviser")
                        .WithMany("AdviserInvoices")
                        .HasForeignKey("AdviserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KonkurCRM.DataLayer.Entities.Salary.SalaryType", "SalaryType")
                        .WithMany("AdviserInvoices")
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Register.Register", b =>
                {
                    ...
                    b.HasOne("KonkurCRM.DataLayer.Entities.Pays.PayType", "PayType")
                        .WithMany("Registers")
            ...
            modelBuilder.Entity("KonkurCRM.DataLayer.Entities.Advisers.Adviser", b =>
                {
                    ...
                    b.Navigation("AdviserInvoices");

                    b.Navigation("Advisers");

                    b.Navigation("NotCalleds");
